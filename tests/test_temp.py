...
class EfficientCrossAttention(nn.Module):
    def __init__(self, feature_dim):
        ...
        self.query_conv = nn.Conv2d(feature_dim, feature_dim, kernel_size=3, padding=1)
...
class MRIReconstructionModel(nn.Module):
    ...
    def forward(self, target_slice, adjacent_slices):
        ...
        attended_features = self.efficient_cross_attention(target_features, adjacent_slices)

        combined_features = attended_features + target_features
