...
class C2DataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        self.data_train = SliceDataset(self.hparams.data_dir_train,
        ...
        self.data_val = SliceDataset(self.hparams.data_dir_val,
                                       ...
                                       crop_slice_idx = self.hparams.crop_slice_idx,
                                       num_slices = self.num_slices)
        self.data_test = SliceDataset(self.hparams.data_dir_test,
