...
from src.data.components.calgary_campinas_dataset_3d import SliceDataset
...
class C2DataModule(LightningDataModule):
    ...
    def test_dataloader(self) -> DataLoader[Any]:
        ...
        return DataLoader(
            ...
            batch_size=self.batch_size_per_device,#256-self.hparams.crop_slice_idx,#self.batch_size_per_device, # TODO: make 256 felixible,
            num_workers=self.hparams.num_workers,
            pin_memory=self.hparams.pin_memory,
            shuffle=False,
        )
