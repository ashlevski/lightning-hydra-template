...
from src.data.components.calgary_campinas_dataset_mv_reg import SliceDataset
...
class C2DataModule(LightningDataModule):
    ...
    def val_dataloader(self) -> DataLoader[Any]:
        ...
        return DataLoader(
            ...
            batch_size=156,#self.batch_size_per_device,
            num_workers=0,
            pin_memory=self.hparams.pin_memory,
            shuffle=False,
        )
    ...
    def test_dataloader(self) -> DataLoader[Any]:
        ...
        return DataLoader(
            ...
            batch_size=256-self.hparams.crop_slice_idx*2,#self.batch_size_per_device,#256-self.hparams.crop_slice_idx*2,# # TODO: make 256 felixible
            num_workers=self.hparams.num_workers,
            pin_memory=self.hparams.pin_memory,
            shuffle=False,
        )
