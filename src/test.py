# /home/amir/PycharmProjects/MRI_REC_template/logs/train/runs/2024-02-21_20-33-34/checkpoints/epoch_072.ckpt
import os
...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    try:
        ...
        print("torch is old so it cannot set matmul precision")
    ...
    test_class.forward(model)
    log.warning("successful testing")
