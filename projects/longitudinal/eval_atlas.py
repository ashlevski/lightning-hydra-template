...
methods = [
'Non-enhanced [E2EVarNet]',
'Enhanced [Trained and tested on previous scans]',
'Enhanced [Trained and tested on the atlas]',
'Enhanced [Trained on previous scan and tested on the atlas]'
]
