...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            DiTBlock(hidden_size, num_heads, mlp_ratio=mlp_ratio,drop=drop) for _ in range(depth)
        ])
    ...
    def initialize_weights(self):
        ...
        k = self.y_embedder.proj.weight.data
        nn.init.xavier_uniform_(k.view([k.shape[0], -1]))
