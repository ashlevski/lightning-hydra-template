...
from projects.longitudinal.layer_norm import LayerNormANE
...
from projects.longitudinal import attention
...
def create_tensors(B):
    # Create the first tensor with size B, 1, 218, 170
